...
#sudo docker run -d   --name metrics-client   --restart unless-stopped   --network host   -e CENTRAL_HOST=https://monitoring.takeleap.in   -e DB_HOST=localhost   -e DB_USER=root   -e DB_PASSWORD=password   -e DB_NAME=take_leap   -e DB_PORT=3306   nikhilvyamsani/metrics-client:latest
